...
class VoyageRatingTest {
    ...
    @Test
    void westIndies() {
        VoyageRating voyageRating = RatingFactory.createVoyageRating(new Voyage("west-inides", 10),
                List.of(
                        new VoyageHistory("east-indies", 5),
    ...
    @Test
    void china() {
        VoyageRating voyageRating = RatingFactory.createVoyageRating(new Voyage("china", 10),
                List.of(
                        new VoyageHistory("east-indies", 5),
                        new VoyageHistory("west-indies", 15),
                        new VoyageHistory("china", -2),
