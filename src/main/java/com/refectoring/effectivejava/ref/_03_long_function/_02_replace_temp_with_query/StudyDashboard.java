package com.refectoring.effectivejava.ref._03_long_function._02_replace_temp_with_query;
    ...
    private void print() throws IOException, InterruptedException {
        ...
        try (
           ...
           participants.forEach(p -> {
               String markdownHomework = getMarkdownForParticipant(totalNumberOfEvents, p);
